...
El equipo utiliza Feature Branch Flow. Cada tarea se desarrolla en una rama independiente y se integra al main mediante PR con revision de otro integrante
...
| Escala Fibonacci | Interpretación |
|---|---|
| 1 | muy bajo |
| 2 | bajo |
| 3 | medio-bajo |
...
#El seguimiento se hace mediante Github Issues
Estados:
    Backlog
    En progreso
    En revisión
